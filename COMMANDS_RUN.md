...
| 2026-05-16T14:20Z | repository root | May 15 source zip import into repo root | 0 | Wrote 1,140 `proofbundle/` source entries into the repository working tree. Skipped wrapper entries: `plan.md` and `proofbundle-v1.0.0-alpha-repair-snapshot.zip`. Report: `manifest/source_baselines/source_zip_import_report_20260516T142055Z.json`. |
| 2026-05-16T14:21Z | repository root | `python tools/compare_source_zip_to_repo_20260516.py <source-zip> . manifest/source_baselines/source_zip_vs_repo_diff_after_import_20260516T142100Z.json` | 0 | Post-import comparison found 351/351 shared clean-scope paths identical and 0 differing paths. Remaining 791 source paths are generated/vendor/cache/archive-wrapper material. |
| 2026-05-16T14:22Z | repository root | `Get-Content manifest/source_baselines/source_zip_import_paths_20260516T142055Z.txt | git check-ignore -v --stdin` | 0 | Verified remaining untracked source-archive paths are ignored by clean repo hygiene rules: `node_modules`, `dist`, Python caches, egg-info, and logs/Cargo lock where force-add is required for evidence/source tracking. |
| 2026-05-16T14:24Z | repository root | `node tools/build_repo_merkle_manifest_20260516.mjs` | 0 | Regenerated clean-scope repo Merkle manifest after May 15 baseline import. Root `13C260DC388235C0D30821541D8E58F16F9CE2B3EE8B9227195F2E65259E9459`; manifest SHA-256 `BFC2D4EBB962150074E7AA0ECAB2AE2B4687DE4694799108DC4925F812395230`; zero-byte files: `.gitkeep`, `python/tests/__init__.py`. |
| 2026-05-16T14:24Z | repository root | `node tests/proofbundle_app_static.test.mjs` | 0 | Browser app static tests passed 4/4 after baseline import. |
| 2026-05-16T14:24Z | repository root | PowerShell JSON parse of `conformance/vectors_v1.json` | 0 | Verified May 15 baseline conformance corpus count 300, IDs `CV0001` through `CV0300`, unique IDs 300. |
